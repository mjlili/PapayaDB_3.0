...
public class DataBase {
	...
	private void createNewDatabase() throws IOException {
		synchronized (indexes) {
			Files.createFile(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/"
					+ databaseName + ".dbtmp"));
			RandomAccessFile raf = new RandomAccessFile(
					DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + databaseName + ".dbtmp",
					"rw");
			...
			Files.delete(Paths.get(
					DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + databaseName + ".db"));
			Files.move(
					Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + databaseName
							+ ".dbtmp"),
					Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + databaseName
							+ ".db"));
		}
	...
	private void updateIndexInPhysicalStorage(String indexName) throws IOException {
		Files.createFile(Paths.get(
				DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "tmpindex_" + indexName));
		try (RandomAccessFile raf = new RandomAccessFile(
				DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "tmpindex_" + indexName,
				"rw")) {
		...
		if (Files.exists(Paths.get(
				DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "index_" + indexName))) {
			Files.delete(Paths.get(
					DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "index_" + indexName));
		}
		Files.move(
				Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "tmpindex_"
						+ indexName),
				Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + databaseName + "/" + "index_"
						+ indexName));
	}
