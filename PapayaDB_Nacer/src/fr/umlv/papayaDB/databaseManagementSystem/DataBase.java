...
public class DataBase{
	...
	private void createNewDatabase() throws IOException{
		synchronized (indexs){
			Files.createFile(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" 
					+ name + ".dbtmp"));
			RandomAccessFile raf = new RandomAccessFile(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY 
					+ name + "/" + name + ".dbtmp", "rw");
			...
			docs = newDocs;
			Files.delete(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY 
					+ name + "/" + name + ".db"));
			Files.move(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" + name + 
					".dbtmp"), Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" + 
							name + ".db"));
		}
	}
	...
	private void updateIndexInPhysicalStorage(String indexName) throws IOException{
		Files.createFile(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" 
				+ "tmpindex_" + indexName ));
		try(RandomAccessFile raf = new RandomAccessFile(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY 
		...
		if(Files.exists(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" 
				+ "index_" + indexName ))){
			Files.delete(Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY 
					+ name + "/" + "index_" + indexName));
		}
		Files.move( Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" 
				+ "tmpindex_" + indexName), 
				Paths.get(DataBaseManagementSystem.PATH_OF_DATABASE_DIRECTORY + name + "/" + 
						"index_" + indexName));	
	}
